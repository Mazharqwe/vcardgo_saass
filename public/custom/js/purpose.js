            ...
            $("body").on("click", "[data-action]", function (a) {
                ...
                switch (o) {
                    ...
                    case "omnisearch-close":
                        (i = n.data("target")),
                            $('[data-action="search-open"]').removeClass(
                                "active"
                            ),
                            $(i).removeClass("show"),
                            $("body")
            ...
            t.on({
                "hide.bs.collapse": function () {
                    t.removeClass("collapsing").addClass("collapsing-out"),
                        e
                            .removeClass("navbar-collapsed")
                            .addClass("navbar-collapsed-out"),
                        a
                            .removeClass("navbar-collapsed")
                            .addClass("navbar-collapsed-out");
                },
                ...
                click: function () {
                    !(function (e) {
                        ...
                        var t = e.parents(".pricing-container"),
                            a = $(
                                "." + t.attr("class") + " [data-pricing-value]"
                            );
                        e.hasClass("active") ||
                            ($(
                                "." + t.attr("class") + " button[data-pricing]"
                            ).removeClass("active"),
                            e.addClass("active"),
                            a.each(function () {
                        ...
                        !(function (e) {
                            ...
                            if ("fullscreen" == e.data("spotlight")) {
                                if (e.data("spotlight-offset")) {
                                    var a = $("body")
                                        .find(e.data("spotlight-offset"))
                                        .height();
                                    t = $(window).height() - a;
                                } else t = $(window).height();
                                $(window).width() > 991
                                    ? e
                                          .find(".spotlight-holder")
                                          .css({ height: t + "px" })
                                    : e
                                          .find(".spotlight-holder")
                                          .css({ height: "auto" });
            ...
            e.each(function () {
                ...
                $(this),
                    ...
                    noUiSlider.create(e, {
                        ...
                        range: {
                            min: parseInt(
                                e.getAttribute("data-range-value-min")
                            ),
                            max: parseInt(
                                e.getAttribute("data-range-value-max")
                            ),
                        },
                    }),
        ...
        $(window).on("load resize", function () {
            e.length &&
                e.each(function () {
                    ...
                    (e = $(this)),
                        (t = {
                            offset_top: e.data("sticky-offset")
                                ? e.data("sticky-offset")
                                : 0,
                        }),
                        $(window).width() > 1e3
                            ? e.stick_in_parent(t)
            ...
            e.length &&
                e.each(function (e, t) {
                    ...
                    (a = $(t)),
                        ...
                        (r = n.data("swiper-effect")
                            ? n.data("swiper-effect")
                            : "slide"),
                        ...
                        (d = n.data("swiper-initial-slide")
                            ...
                            : 0),
                        (c =
                            !!n.data("swiper-autoheight") &&
                            n.data("swiper-autoheight")),
                        (u =
                            !!n.data("swiper-autoplay") &&
                            n.data("swiper-autoplay")),
                        (p =
