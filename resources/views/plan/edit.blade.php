...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="input-group">
            <input class="form-control" required="required" name="storage_limit" type="number" id="storage_limit" value="{{$plan->storage_limit}}">
    ...
    <div class="col-6"><br>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-primary" name="enable_qr_code" id="enable_qr_code"
                {{ $plan['enable_qr_code'] == 'on' ? 'checked=checked' : '' }}>
            <label class="branding-control-label form-control-label"
