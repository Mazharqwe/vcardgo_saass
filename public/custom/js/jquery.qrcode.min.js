/*! jquery-qrcode v0.18.0 - https://larsjung.de/jquery-qrcode/ */ ! function (t, r) {
    ...
    return n = {}, o.m = e = [function (t, r, f) {
        ...
        function i(t, r, e) {
            p(e.background) ? r.drawImage(e.background, 0, 0, e.size, e.size) : e.background && (r.fillStyle = e.background, r.fillRect(e.left, e.top, e.size, e.size));
            var n, o, i, a, u, f, l, c, g, s, h, d, v = e.mode;
            1 === v || 2 === v ? function (t, r, e) {
                var n = e.size,
                ...
                var a = i.measureText(e.label).width,
                    ...
                    g = l + f,
                    s = c + u;
                1 === e.mode ? t.add_blank(0, c - .01, n, s + .01) : t.add_blank(l - .01, c - .01, .01 + g, s + .01), r.fillStyle = e.fontcolor, r.font = o, r.fillText(e.label, l * n, c * n + .75 * e.mSize * n)
            }(t, r, e) : !p(e.image) || 3 !== v && 4 !== v || (n = t, o = r, a = (i = e).size, u = i.image.naturalWidth || 1, f = i.image.naturalHeight || 1, l = i.mSize, g = (1 - (c = l * u / f)) * i.mPosX, s = (1 - l) * i.mPosY, h = g + c, d = s + l, 3 === i.mode ? n.add_blank(0, s - .01, a, d + .01) : n.add_blank(g - .01, s - .01, .01 + h, d + .01), o.drawImage(i.image, g * a, s * a, c * a, l * a))
        }
        ...
        function d(t, r, e, n, o, i, a, u) {
            var f, l, c, g, s, h, d, v, p, w, y, m, b, k, x, B, C, A, M, S = n + i,
                L = o + i,
                D = e.radius * i,
                T = a - 1,
                z = a + 1,
                ...
                U = I(z, P),
                V = I(a, P);
            _ ? (w = r, y = n, m = o, b = S, k = L, x = D, C = !O && !R, A = !N && !R, M = !N && !V, (B = !O && !V) ? w.m(y + x, m) : w.m(y, m), C ? w.l(b - x, m).a(b, m, b, k, x) : w.l(b, m), A ? w.l(b, k - x).a(b, k, y, k, x) : w.l(b, k), M ? w.l(y + x, k).a(y, k, y, m, x) : w.l(y, k), B ? w.l(y, m + x).a(y, m, b, m, x) : w.l(y, m)) : (f = r, l = n, c = o, g = S, s = L, h = D, d = O && R && F, v = N && R && H, p = N && V && U, O && V && q && f.m(l + h, c).l(l, c).l(l, c + h).a(l, c, l + h, c, h), d && f.m(g - h, c).l(g, c).l(g, c + h).a(g, c, g - h, c, h), v && f.m(g - h, s).l(g, s).l(g, s - h).a(g, s, g - h, s, h), p && f.m(l + h, s).l(l, s).l(l, s - h).a(l, s, l + h, s, h))
        }
        ...
        function n(t, r) {
            ...
            return i(e, o, r),
                function (t, e, r) {
                    ...
                    p(r.fill) ? (e.strokeStyle = "rgba(0,0,0,0.5)", e.lineWidth = 2, e.stroke(), u = e.globalCompositeOperation, e.globalCompositeOperation = "destination-out", e.fill(), e.globalCompositeOperation = u, e.clip(), e.drawImage(r.fill, 0, 0, r.size, r.size), e.restore()) : (e.fillStyle = r.fill, e.fill())
                }(e, o, r), n
        }
        ...
        function o(t) {
            return "canvas" === t.render ? e(t) : "image" === t.render ? (r = t, w("<img/>").attr("src", e(r)[0].toDataURL("image/png"))) : function (t) {
                ...
                for (var g = 0; g < i; g += 1)
                    for (var s = 0; s < i; s += 1) r.is_dark(g, s) && w("<div/>").css(l).css({
                        left: u + s * a,
                        top: u + g * a
                    }).appendTo(c);
                return c
        ...
        var n, o, i, a = function () {
            function i(t, r) {
                function a(t, r) {
                    c = function (t) {
                        ...
                        return r
                    }(g = 4 * u + 17), e(0, 0), e(g - 7, 0), e(0, g - 7), i(), o(), d(t, r), 7 <= u && s(t), null == n && (n = p(u, f, l)), v(n, r)
                }
                var u = t,
                    f = y[r],
                    c = null,
                    ...
                    e = function (t, r) {
                        for (var e = -1; e <= 7; e += 1)
                            if (!(t + e <= -1 || g <= t + e))
                                for (var n = -1; n <= 7; n += 1) r + n <= -1 || g <= r + n || (c[t + e][r + n] = 0 <= e && e <= 6 && (0 == n || 6 == n) || 0 <= n && n <= 6 && (0 == e || 6 == e) || 2 <= e && e <= 4 && 2 <= n && n <= 4)
                    },
                    o = function () {
                    ...
                    i = function () {
                        for (var t = m.getPatternPosition(u), r = 0; r < t.length; r += 1)
                            for (var e = 0; e < t.length; e += 1) {
                                ...
                                if (null == c[n][o])
                                    for (var i = -2; i <= 2; i += 1)
                                        for (var a = -2; a <= 2; a += 1) c[n + i][o + a] = -2 == i || 2 == i || -2 == a || 2 == a || 0 == i && 0 == a
                            }
                    },
                    s = function (t) {
                        ...
                        for (var e = -1, n = g - 1, o = 7, i = 0, a = m.getMaskFunction(r), u = g - 1; 0 < u; u -= 2)
                            for (6 == u && --u;;) {
                                for (var f, l = 0; l < 2; l += 1) {
                                    null == c[n][u - l] && (f = !1, i < t.length && (f = 1 == (t[i] >>> o & 1)), a(n, u - l) && (f = !f), c[n][u - l] = f, -1 == --o && (i += 1, o = 7))
                                }
                                if ((n += e) < 0 || g <= n) {
                                    n -= e, e = -e;
                                    break
                    ...
                    p = function (t, r, e) {
                        ...
                        return function (t, r) {
                            ...
                            for (c = 0; c < o; c += 1)
                                for (u = 0; u < r.length; u += 1) c < a[u].length && (v[p] = a[u][c], p += 1);
                            return v
                        }(o, n)
                    };
                h.addData = function (t, r) {
                    ...
                    for (l += '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"', l += o.scalable ? "" : ' width="' + f + 'px" height="' + f + 'px"', l += ' viewBox="0 0 ' + f + " " + f + '" ', l += ' preserveAspectRatio="xMinYMin meet"', l += n.text || e.text ? ' role="img" aria-labelledby="' + w([n.id, e.id].join(" ").trim()) + '"' : "", l += ">", l += n.text ? '<title id="' + w(n.id) + '">' + w(n.text) + "</title>" : "", l += e.text ? '<description id="' + w(e.id) + '">' + w(e.text) + "</description>" : "", l += '<rect width="100%" height="100%" fill="white" cx="0" cy="0"/>', l += '<path d="', a = 0; a < h.getModuleCount(); a += 1)
                        for (u = a * t + r, i = 0; i < h.getModuleCount(); i += 1) h.isDark(a, i) && (l += "M" + (i * t + r) + "," + u + c);
                    ...
                    var n = h.getModuleCount() * t + 2 * r,
                        o = "";
                    return o += "<img", o += ' src="', o += h.createDataURL(t, r), o += '"', o += ' width="', o += n, o += '"', o += ' height="', o += n, o += '"', e && (o += ' alt="', o += w(e), o += '"'), o += "/>"
                };
                var w = function (t) {
                ...
                return h.createASCII = function (t, r) {
                    if ((t = t || 1) < 2) return function (t) {
                        ...
                        for (var r, e, n, o, i = +h.getModuleCount() + 2 * t, a = t, u = i - t, f = {
                            ...
                            for (e = Math.floor(g - a), n = Math.floor(g + 1 - a), r = 0; r < i; r += 1) o = "Ã¢â€“Ë†", a <= r && r < u && a <= g && g < u && h.isDark(e, Math.floor(r - a)) && (o = " "), a <= r && r < u && a <= g + 1 && g + 1 < u && h.isDark(n, Math.floor(r - a)) ? o += " " : o += "Ã¢â€“Ë†", c += t < 1 && u <= g + 1 ? l[o] : f[o];
                            c += "\n"
                        }
                        return i % 2 && 0 < t ? c.substring(0, c.length - i - 1) + Array(1 + i).join("Ã¢â€“â‚¬") : c.substring(0, c.length - 1)
                    }(r);
                    --t, r = void 0 === r ? 2 * t : r;
                    for (var e, n, o, i = h.getModuleCount() * t + 2 * r, a = r, u = i - r, f = Array(t + 1).join("Ã¢â€“Ë†Ã¢â€“Ë†"), l = Array(t + 1).join("  "), c = "", g = "", s = 0; s < i; s += 1) {
                        for (n = Math.floor((s - a) / t), g = "", e = 0; e < i; e += 1) o = 1, a <= e && e < u && a <= s && s < u && h.isDark(n, Math.floor((e - a) / t)) && (o = 0), g += o ? f : l;
                        for (n = 0; n < t; n += 1) c += g + "\n"
                    }
            ...
            var r, t, a = 1,
                ...
                m = (r = [
                    ...
                    for (n = 0; n < r - 1; n += 1)
                        for (o = 0; o < r - 1; o += 1) {
                            var l = 0;
                            t.isDark(n, o) && (l += 1), t.isDark(n + 1, o) && (l += 1), t.isDark(n, o + 1) && (l += 1), t.isDark(n + 1, o + 1) && (l += 1), 0 != l && 4 != l || (e += 3)
                        }
                    for (n = 0; n < r; n += 1)
                ...
                var n = t,
                    ...
                    i = function (t) {
                        ...
                        for (g += 1; g < d.length;) {
                            ...
                            g += 1, o.contains(s + h) ? s += h : (c.write(o.indexOf(s), n), o.size() < 4095 && (o.size() == 1 << n && (n += 1), o.add(s + h)), s = h)
                        }
            ...
            var B, C, A = (B = [
                    ...
                    for (var n, o, i = e.length / 3, a = [], u = 0; u < i; u += 1)
                        for (var f = e[3 * u + 0], l = e[3 * u + 1], c = e[3 * u + 2], g = 0; g < f; g += 1) a.push((n = c, o = void 0, (o = {}).totalCount = l, o.dataCount = n, o));
                    return a
                }, C),
                M = function () {
                    var e = [],
